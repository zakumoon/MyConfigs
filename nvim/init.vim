...
" neccecery paths for neovim checkhealth
let g:python3_host_prog = expand('~/.venvs/neovim/bin/python')
let g:loaded_ruby_provider = '/usr/lib/ruby'
let g:loaded_node_provider = '/usr/lib/node_modules'
let g:loaded_perl_provider = '/usr/lib/perl5'
